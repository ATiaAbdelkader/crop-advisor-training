...
| **26. Fertilisation of vegetables** | Building soil- and crop-grounded nutrient plans through nutrient uptake, the 4Rs, source selection, nutrient analysis, effective placement, and responsible decision-making. | Diagnose limiting factors; assess soil supply and crop demand; apply the 4Rs; compare sources; interpret labels; choose an effective application method. | **Build a 4R plan from soil and crop demand**; **Select sources and place nutrients effectively** | Both lessons complete and module check passed at 80% or above. |
...
| **Prepare seedlings and field for transplanting** | Coordinate field readiness, mulch, trellis, holes, nutrient placement, moisture, hardening, plant stage, and heat-aware scheduling. | Transplanting begins before plants leave the nursery: field and seedlings must be ready together. |
| **Establish transplants and protect the stand** | Remove tray plants carefully, plant at the right level, protect cotyledons and roots, moderate heat, prevent nutrient burn, monitor, and replace losses. | A uniform stand is secured through careful early handling and daily recovery action, not by planting alone. |
| **Read water-air balance and crop demand** | Assess root-zone water and air, diagnose over- and under-supply, read moisture by feel, and adapt irrigation to soil, crop stage, and climate. | Irrigate the functioning root zone—not a calendar or a volume target alone. |
...
| **Build a 4R plan from soil and crop demand** | Diagnose soil constraints and nutrient interactions; establish crop demand from soil supply, uptake, removal, residues, and stage; set the 4Rs. | A fertiliser plan must resolve the limiting factor and match nutrient supply to crop demand. |
| **Select sources and place nutrients effectively** | Compare organic and inorganic sources, interpret nutrient labels, and match placement method to roots, timing, field conditions, and crop safety. | Product choice only becomes efficient when its nutrient analysis, application method, and soil effects fit the field plan. |
| **Maintain crop structure and canopy health** | Time support installation; prune for crop purpose; use sanitation; and train vines or branches to protect crop structure, airflow, and field access. | Structural crop care is preventive management of wind, disease, fruit contact, canopy crowding, and labour access. |
| **Protect pollination, fruit set, and market quality** | Diagnose pollination constraints, use manual pollination when justified, and support fruit to preserve clean, high-quality produce. | Fruit-set and quality problems require biological, crop-health, and field-condition diagnosis before intervention. |
| **Harvest at market-ready maturity without damage** | Set maturity and timing from crop and market evidence, then use low-injury harvesting and field handling practices. | Quality is protected by maturity, timing, tools, containers, shade, and gentle handling before the crop leaves the field. |
...
| **Recognise pest life cycles and damage patterns** | Distinguish complete and incomplete metamorphosis; inspect damaging stage, crop part, feeding injury, distribution, and vector-linked symptoms across chewing, mining, boring, sucking, and mite pests. | Record the stage actually observed; do not assume the adult seen on the crop is the stage causing injury. |
...
| **Diagnose weed pressure and critical interference** | Scout and map weeds by type, density, crop stage, field pattern, flowering and seed-set risk, and pest or disease-host context; then protect crop-specific critical interference periods. | Weed pressure is a crop-stage and density decision, not a calendar task or a complaint about untidy ground. |
| **Identify and manage weeds integratively** | Classify grasses, sedges, and broadleaves; assess annual, biennial, or perennial persistence; then combine physical, cultural, biological, and lawful label-directed chemical control where justified. | Control must interrupt seed, tuber, rhizome, or other regrowth mechanisms—not only remove visible top growth. |
...
| **Vegetable-fertilisation check** | Soil condition and limiting factors, crop uptake and removal, soil testing, pH, nutrient sources, label interpretation, application methods, and the 4Rs. | 4 | 80% | Unlocks the integrated final assessment only after both Module 26 lessons are complete and the check is passed. |
...
| **Weed-management check** | Early scouting, weed density, critical interference periods, pest and disease-host context, grass/sedge/broadleaf identification, life cycle, seed and tuber persistence, integrated physical/cultural/biological/chemical control, and lawful herbicide safeguards. | 4 | 80% | Unlocks the integrated final assessment only after both Module 34 lessons are complete and the check is passed. |
| **Final integrated assessment** | Advisory sequence, soil context, management-zone evidence, uncertainty management, whole-system vegetable planning, cost-based revision decisions, crop-and-variety selection, genetic-environmental yield fit, crop-stage climatic-risk management, topographic site interpretation, complete edaphic soil assessment, integrated soil-protection planning, balanced plant-nutrition decisions, integrated nutrient management, acid-soil management, soil-health promotion, representative soil-sample collection, protected vegetable-nursery management, open-field bare-root seedling production, protected cellular seedling production, seedling-production planning, field preparation, mulching, trellising, transplanting, water management, irrigation-system selection, drip-system planning and maintenance, efficient vegetable fertilisation, field-care and maintenance decisions, harvest and post-harvest loss control, evidence-led field diagnosis, integrated disease management, insect-pest and mite identification and management, integrated pest-management decision making, responsible pesticide stewardship, and integrated weed management. | 35 | 80% | Issues certificate after a pass; a new certificate event triggers an owner notification. |
...
| **Correct a universal fertiliser schedule** | Low soil potassium, large nitrogen doses throughout the cycle, and the same product and rate broadcast in every field. | Connects limiting factors, soil NPK and pH, crop uptake and removal, stage, label analysis, root access, nutrient antagonism, losses, and the 4Rs. | Efficient fertilisation corrects the field’s limiting factor and matches source, rate, timing, and placement to evidence. |
...
| **Break a weed-competition and persistence cycle** | Direct-seeded tomato with patchy early weeds, flowering purslane, triangular-stem grass-like plants, persistent nutsedge, and a proposed broad herbicide spray in wind. | Connects density, critical crop stage, weed morphology, seed and tuber persistence, pest and disease-host context, integrated controls, and lawful herbicide safeguards. | Weed management protects yield and crop health by matching action to species, persistence, crop stage, and field risk rather than using an unverified broad spray. |
...
flowchart TD
  ...
  AE -- No --> AD
  AE -- Yes --> AF[Unlock Module 10]
  AF --> AG[Module 10 lessons and assessment]
  AG --> AH{Module 10 passed?}
  AH -- No --> AG
  AH -- Yes --> AI[Unlock Module 11]
  ...
  AN -- No --> AM
  AN -- Yes --> AO[Unlock Module 13]
  AO --> AP[Module 13 lessons and assessment]
  AP --> AQ{Module 13 passed?}
  AQ -- No --> AP
  AQ -- Yes --> AR[Unlock Module 14]
  ...
  BO -- No --> BN
  BO -- Yes --> BP[Unlock Module 22]
  BP --> BQ[Module 22 lessons and assessment]
  BQ --> BR{Module 22 passed?}
  BR -- No --> BQ
  BR -- Yes --> BS[Unlock Module 23]
  BS --> BT[Module 23 lessons and assessment]
  BT --> BU{Module 23 passed?}
  BU -- No --> BT
  BU -- Yes --> BV[Unlock Module 24]
  ...
  CA -- No --> BZ
  CA -- Yes --> CB[Unlock Module 26]
  CB --> CC[Module 26 lessons and assessment]
  CC --> CD{Module 26 passed?}
  CD -- No --> CC
  CD -- Yes --> CE[Unlock Module 27]
  CE --> CF[Module 27 lessons and assessment]
  CF --> CG{Module 27 passed?}
  CG -- No --> CF
  CG -- Yes --> CH[Unlock Module 28]
  CH --> CI[Module 28 lessons and assessment]
  CI --> CJ{Module 28 passed?}
  CJ -- No --> CI
  CJ -- Yes --> CK[Unlock Module 29]
  ...
  CP -- No --> CO
  CP -- Yes --> CQ[Unlock Module 31]
  CQ --> CR[Module 31 lessons and assessment]
  CR --> CS{Module 31 passed?}
  CS -- No --> CR
  CS -- Yes --> CT[Unlock Module 32]
  ...
  CY -- No --> CX
  CY -- Yes --> CZ[Unlock Module 34]
  CZ --> DA[Module 34 lessons and assessment]
  DA --> DB{Module 34 passed?}
  DB -- No --> DA
  DB -- Yes --> DC[Unlock integrated final assessment]
  DC --> DD{Final score at least 80%?}
  DD -- No --> DE[Feedback and final retake available]
  DE --> DC
  DD -- Yes --> DF[Create credential record]
  DF --> DG[Notify platform owner]
  DG --> DH[Enable certificate download]
```
...
Module 22 is derived from the supplied *Transplanting* training document. Its instructional structure retains field-readiness checks, mulch and trellis readiness, nutrient placement safeguards, seedling moisture, gradual hardening, crop-stage timing, careful tray removal, correct planting level, cotyledon protection, heat moderation, early monitoring, and rapid stand replacement. The platform renders these themes as two adult-learning lessons, four applied assessment items, a module gate, and one final-assessment item. [19]

Module 23 is derived from the supplied *Water Management* training document. Its instructional structure retains root-zone water-air balance, over- and under-watering signs, soil-moisture assessment, texture and structure effects, crop-stage and climate demand, irrigation-system performance, dry-season conservation, wet-season drainage, water quality, and untreated-wastewater safeguards. The platform renders these themes as two adult-learning lessons, four applied assessment items, a module gate, and one final-assessment item. [20]
...
Module 26 is derived from the supplied *Fertilization of Vegetables* training document. Its instructional structure retains soil physical, biological, and chemical conditions; nutrient availability, limiting factors, antagonism, fixation, and losses; crop uptake, removal, residues, NPK and pH testing; stage-based nutrient demand; the 4Rs; organic and inorganic source choices; label analysis; application methods; and return-focused fertiliser decision-making. The platform renders these themes as two adult-learning lessons, four applied assessment items, a module gate, and one final-assessment item. [23]

Module 27 is derived from the supplied *Field Care and Maintenance of Vegetable Crops* training document. Its instructional structure retains crop-family support timing, trellising materials and construction, canopy and disease-management pruning, tool hygiene, crop training, pollination biology and diagnosis, careful manual pollination, fruit-set constraints, and fruit support for market quality. The platform renders these themes as two adult-learning lessons, four applied assessment items, a module gate, and one final-assessment item. [24]

Module 28 is derived from the supplied *Harvesting and Post-Harvest Handling* training document. Its instructional structure retains commercial and physiological maturity, crop-specific harvest indices, harvest timing, low-injury tools and containers, shade and soil-contact safeguards, cleaning, curing, crop-suitable cooling, sorting and grading, approved post-harvest options, and food-safety controls for manure, water, pesticide intervals, surfaces, and equipment. The platform renders these themes as two adult-learning lessons, four applied assessment items, a module gate, and one final-assessment item. [25]
...
Module 31 is derived from the supplied *Insect Pests and Mites (Acari) Identification and Management* training document. Its instructional structure retains complete and incomplete metamorphosis, damaging-stage inspection, chewing, mining, boring, sucking, and mite injury patterns, crop-part and vector risk, scouting, sanitation, weed and residue control, aeration, reflective mulch, netting, target-aware traps, hand removal, natural enemies, biological and botanical tools, beneficial-insect safeguards, and lawful IPM-oriented crop protection. The platform renders these themes as two adult-learning lessons, four applied assessment items, a module gate, and one final-assessment item. [28]
...
Module 34 is derived from the supplied *Weed Management* training document. Its instructional structure retains 1 m × 1 m weed sampling, local weed records, early and full-field scouting, density and crop-stage interference, crop-specific critical periods, alternate-host and operational risk, grass/sedge/broadleaf identification, annual-biennial-perennial life cycles, seed, tuber, and rhizome persistence, physical, cultural, biological, and chemical controls, mulch, timely hand removal, tillage, solarisation, and lawful herbicide-use safeguards for wind, drift, equipment, PPE, and label instructions. The platform renders these themes as two adult-learning lessons, four applied assessment items, a module gate, and one final-assessment item. [31]
...
[19] [REVISED_PRD-006. *Transplanting* (user-supplied training document, 24 May 2023)](file:///home/ubuntu/upload/REVISED_PRD-006.Transplanting_05242023.pdf)
...
[23] [REVISED_PRD-010. *Fertilization of Vegetables* (user-supplied training document, 11 May 2023)](file:///home/ubuntu/upload/REVISED_PRD-010.FertilizationofVegetables_05112023.pdf)

[24] [REVISED_PRD-011. *Field Care and Maintenance of Vegetable Crops* (user-supplied training document, 12 May 2023)](file:///home/ubuntu/upload/REVISED_PRD-011.FieldCareandMaintenanceofVegetableCrops_05122023.pdf)
