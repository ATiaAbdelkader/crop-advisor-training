...
import { ipmDecisionExerciseRequirements } from "@shared/ipmDecisionExercise";
import { pesticideReadinessExerciseRequirements } from "@shared/pesticideReadinessExercise";
import { weedObservationExerciseRequirements } from "@shared/weedObservationExercise";
import { fieldCareMaintenanceExerciseRequirements } from "@shared/fieldCareMaintenanceExercise";
import { harvestQualityEvidenceExerciseRequirements } from "@shared/harvestQualityEvidenceExercise";
import { fieldLayoutEvidenceExerciseRequirements } from "@shared/fieldLayoutEvidenceExercise";
      ...
      <main className="mx-auto max-w-[1520px] px-5 py-6 sm:px-8 lg:py-8">
        ...
        <div className="grid gap-6 xl:grid-cols-[286px_minmax(0,1fr)_260px]">
          ...
          <aside className="space-y-4 xl:sticky xl:top-24 xl:h-fit">
            ...
            {module.id === "integrated-pest-management" && <div className="rounded-[22px] border border-[#cfe1d0] bg-[#eef7ec] p-5"><Search className="h-4 w-4 text-[#4c7e57]"/><p className="mt-4 text-[10px] font-bold uppercase tracking-[.18em] text-[#658164]">Interactive field exercise</p><p className="mt-2 text-sm font-semibold text-[#314b39]">IPM Evidence-to-Decision Exercise</p><p className="mt-1 text-xs leading-5 text-[#607460]">Connect prevention, monitoring, identification limits, lower-risk options, and authorised escalation before any decision.</p><Button variant="outline" onClick={()=>setLocation("/ipm-decision-exercise")} className="mt-4 w-full rounded-full border-[#9db99d] bg-white text-xs font-bold text-[#315f47]"><Search className="mr-1.5 h-3.5 w-3.5"/>Open IPM exercise</Button><p className="mt-3 text-[10px] leading-4 text-[#668069]">{ipmDecisionExerciseRequirements.nonGatingBoundary}</p></div>}
            {module.id === "responsible-use-of-pesticides" && <div className="rounded-[22px] border border-[#cfe1d0] bg-[#eef7ec] p-5"><ShieldAlert className="h-4 w-4 text-[#4c7e57]"/><p className="mt-4 text-[10px] font-bold uppercase tracking-[.18em] text-[#658164]">Decision-boundary practice</p><p className="mt-2 text-sm font-semibold text-[#314b39]">Pesticide-Use Readiness Exercise</p><p className="mt-1 text-xs leading-5 text-[#607460]">Practise stopping, verifying the current authorised label, documenting uncertainty, and escalating before any pesticide decision.</p><Button variant="outline" onClick={()=>setLocation("/pesticide-readiness-exercise")} className="mt-4 w-full rounded-full border-[#9db99d] bg-white text-xs font-bold text-[#315f47]"><ShieldAlert className="mr-1.5 h-3.5 w-3.5"/>Open readiness exercise</Button><p className="mt-3 text-[10px] leading-4 text-[#668069]">{pesticideReadinessExerciseRequirements.nonGatingBoundary}</p></div>}
            {module.id === "weed-management" && <div className="rounded-[22px] border border-[#cfe1d0] bg-[#eef7ec] p-5"><Search className="h-4 w-4 text-[#4c7e57]"/><p className="mt-4 text-[10px] font-bold uppercase tracking-[.18em] text-[#658164]">Interactive field exercise</p><p className="mt-2 text-sm font-semibold text-[#314b39]">Integrated Weed Observation Exercise</p><p className="mt-1 text-xs leading-5 text-[#607460]">Connect field pattern, crop context, prevention history, identification limits, and the next evidence or escalation step.</p><Button variant="outline" onClick={()=>setLocation("/weed-observation-exercise")} className="mt-4 w-full rounded-full border-[#9db99d] bg-white text-xs font-bold text-[#315f47]"><Search className="mr-1.5 h-3.5 w-3.5"/>Open weed exercise</Button><p className="mt-3 text-[10px] leading-4 text-[#668069]">{weedObservationExerciseRequirements.nonGatingBoundary}</p></div>}
            {module.id === "field-care-and-maintenance" && <div className="rounded-[22px] border border-[#cfe1d0] bg-[#eef7ec] p-5"><Search className="h-4 w-4 text-[#4c7e57]"/><p className="mt-4 text-[10px] font-bold uppercase tracking-[.18em] text-[#658164]">Interactive field exercise</p><p className="mt-2 text-sm font-semibold text-[#314b39]">Routine Field-Care Evidence Exercise</p><p className="mt-1 text-xs leading-5 text-[#607460]">Practise a repeatable route, evidence note, priority statement, and a safe next evidence or escalation step.</p><Button variant="outline" onClick={()=>setLocation("/field-care-maintenance-exercise")} className="mt-4 w-full rounded-full border-[#9db99d] bg-white text-xs font-bold text-[#315f47]"><Search className="mr-1.5 h-3.5 w-3.5"/>Open field-care exercise</Button><p className="mt-3 text-[10px] leading-4 text-[#668069]">{fieldCareMaintenanceExerciseRequirements.nonGatingBoundary}</p></div>}
            {module.id === "harvesting-and-post-harvest-handling" && <div className="rounded-[22px] border border-[#cfe1d0] bg-[#eef7ec] p-5"><Search className="h-4 w-4 text-[#4c7e57]"/><p className="mt-4 text-[10px] font-bold uppercase tracking-[.18em] text-[#658164]">Interactive quality exercise</p><p className="mt-2 text-sm font-semibold text-[#314b39]">Harvest Quality Evidence Exercise</p><p className="mt-1 text-xs leading-5 text-[#607460]">Observe maturity and handling risk, create a traceability handover, and identify the next quality check or referral.</p><Button variant="outline" onClick={()=>setLocation("/harvest-quality-evidence-exercise")} className="mt-4 w-full rounded-full border-[#9db99d] bg-white text-xs font-bold text-[#315f47]"><Search className="mr-1.5 h-3.5 w-3.5"/>Open quality exercise</Button><p className="mt-3 text-[10px] leading-4 text-[#668069]">{harvestQualityEvidenceExerciseRequirements.nonGatingBoundary}</p></div>}
            {module.id === "field-preparation-mulching-and-trellising" && <div className="rounded-[22px] border border-[#cfe1d0] bg-[#eef7ec] p-5"><Search className="h-4 w-4 text-[#4c7e57]"/><p className="mt-4 text-[10px] font-bold uppercase tracking-[.18em] text-[#658164]">Interactive field exercise</p><p className="mt-2 text-sm font-semibold text-[#314b39]">Field Layout Evidence Exercise</p><p className="mt-1 text-xs leading-5 text-[#607460]">Connect site context, a draft layout, readiness checks, and a safe next evidence or escalation step.</p><Button variant="outline" onClick={()=>setLocation("/field-layout-evidence-exercise")} className="mt-4 w-full rounded-full border-[#9db99d] bg-white text-xs font-bold text-[#315f47]"><Search className="mr-1.5 h-3.5 w-3.5"/>Open layout exercise</Button><p className="mt-3 text-[10px] leading-4 text-[#668069]">{fieldLayoutEvidenceExerciseRequirements.nonGatingBoundary}</p></div>}
