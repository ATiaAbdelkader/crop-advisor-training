...
export default function FieldReadinessHub() {
  ...
  return <TrainingShell wide><main className="mx-auto max-w-[1360px] px-5 py-8 sm:px-8 lg:py-10">
    ...
    <section className="mt-7 rounded-[24px] border border-[#ecd9c5] bg-[#fffaf4] p-6 sm:p-7"><div className="flex flex-wrap items-end justify-between gap-4"><div><p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#8d6a58]">Pesticide incident drill</p><h2 className="mt-2 font-serif text-2xl font-semibold text-[#56392d]">Practise a safe stop-and-escalate response before an incident grows.</h2><p className="mt-2 max-w-3xl text-sm leading-6 text-[#765e50]">Use four safety stages to stop unsafe work, protect people and water, consult current label-led information and authorised channels, then document and prevent recurrence. This drill does not replace current emergency, medical, product-label, or employer instructions.</p></div><Button variant="outline" onClick={() => setLocation("/pesticide-incident")} className="rounded-full border-[#d1aa8c] bg-white text-xs font-bold text-[#7f4b35] hover:bg-[#fff2e8]"><ShieldAlert className="mr-1.5 h-3.5 w-3.5" />Open four safety stages</Button></div></section>
    <section className="mt-7 rounded-[24px] border border-[#cfe2de] bg-[#f4fbf9] p-6 sm:p-7"><div className="flex flex-wrap items-end justify-between gap-4"><div><p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#58817b]">Quantified scouting protocol</p><h2 className="mt-2 font-serif text-2xl font-semibold text-[#295a55]">Collect comparable field evidence before selecting a response.</h2><p className="mt-2 max-w-3xl text-sm leading-6 text-[#587470]">Use a repeatable sample route, record incidence, severity and field patterns consistently, retain beneficial-organism evidence, then set a reasoned recheck and referral condition. The protocol does not create universal treatment thresholds or prescribe interventions.</p></div><Button variant="outline" onClick={() => setLocation("/scouting-protocol")} className="rounded-full border-[#9bbfb8] bg-white text-xs font-bold text-[#276d65] hover:bg-[#eaf7f3]"><Search className="mr-1.5 h-3.5 w-3.5" />Open four scouting stages</Button></div></section>
    <section className="mt-7 rounded-[24px] border border-[#d9e6d5] bg-[#f7fbf4] p-6 sm:p-7"><div className="flex flex-wrap items-end justify-between gap-4"><div><p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#658164]">Crop-diagnosis photo annotation</p><h2 className="mt-2 font-serif text-2xl font-semibold text-[#2d4834]">Train your eye to record clues without jumping to a diagnosis.</h2><p className="mt-2 max-w-3xl text-sm leading-6 text-[#58705a]">Use simulated crop photographs to locate field patterns, symptoms, insects or beneficial evidence, and uncertainty. The exercise gives safe next-step feedback and does not replace in-field investigation or qualified diagnosis.</p></div><Button variant="outline" onClick={() => setLocation("/diagnosis-annotation")} className="rounded-full border-[#9db99d] bg-white text-xs font-bold text-[#315f47] hover:bg-[#edf5e9]"><ScanSearch className="mr-1.5 h-3.5 w-3.5" />Open annotation exercise</Button></div></section>
